...
const STEPS = [
  {
    ...
    desc: "Indicá el rubro que necesitás y tu localidad.",
  },
  {
    icon: UsersIcon,
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map(({ icon: Icon, title, desc }, i) => (
            <div
              key={title}
              className="rounded-2xl border border-slate-700/60 bg-slate-800/40 p-6 transition hover:border-teal-500/40"
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-teal-600/20 text-teal-400">
        ...
        <div className="mt-20 grid gap-12 lg:grid-cols-2 lg:items-stretch">
          <div className="flex flex-col rounded-2xl border border-slate-700/60 bg-slate-800/40 p-8">
            ...
            <ul className="space-y-3">
              {BENEFITS.map((item) => (
                <li key={item} className="flex items-center gap-3 text-slate-300">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-teal-600/30">
            ...
            <Link
              href="/profesionales"
              className="mt-8 inline-flex items-center gap-2 rounded-xl bg-teal-600 px-6 py-3 font-semibold text-white transition hover:bg-teal-500"
            >
              Ver profesionales
          ...
          <div className="relative min-h-[280px] w-full overflow-hidden rounded-2xl border border-slate-700/60 bg-slate-800/40 aspect-square lg:aspect-auto lg:h-full lg:min-h-0">
            <Image
