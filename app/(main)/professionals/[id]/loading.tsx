      ...
      <div className="mx-auto w-full max-w-4xl space-y-6">
        ...
        <div className="rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
          <div className="flex flex-col gap-6 lg:flex-row">
            <div className="h-40 w-40 rounded-3xl bg-stone-200 animate-pulse" />
            <div className="flex-1 space-y-4">
              <div className="h-4 w-40 rounded-full bg-stone-200 animate-pulse" />
              <div className="h-7 w-64 rounded-full bg-stone-200 animate-pulse" />
              <div className="h-20 rounded-2xl bg-stone-200 animate-pulse" />
              <div className="h-9 w-32 rounded-full bg-stone-200 animate-pulse" />
            </div>
          </div>
        </div>
      </div>
